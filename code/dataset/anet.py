...
class ActivityNet(Dataset):
    ...
    def __init__(self, word2idx_path, annotation_path, v_feat_path, v_feat_path_vgg, max_video_seq_len=48,
                 subset=None):
        """
        Args:
    ...
    def __getitem__(self, index):
        ...
        with h5py.File(self.v_feat_path, 'r') as f:
            visual = np.array(f[vname]['c3d_fc6_features'])
#             visual = np.array(f[vname]['c3d_features'][()])
